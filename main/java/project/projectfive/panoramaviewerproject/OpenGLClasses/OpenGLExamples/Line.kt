...
class Line(center1:FloatArray, center2:FloatArray) {
    ...
    var lineCoords = floatArrayOf( // in counterclockwise order:
        center1[0], center1[1], center1[2],  // top
        center2[0], center2[1], center2[2],  // bottom left
    ...
    private val vertexCount =
        lineCoords.size / COORDS_PER_VERTEX
